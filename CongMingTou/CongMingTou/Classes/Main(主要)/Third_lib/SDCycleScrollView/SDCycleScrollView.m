...
- (void)setImageURLStringsGroup:(NSArray *)imageURLStringsGroup
{
    ...
    [_imageURLStringsGroup enumerateObjectsUsingBlock:^(CMT_LunBoModel * obj, NSUInteger idx, BOOL * stop) {
        NSString *urlString;
        if ([obj isKindOfClass:[CMT_LunBoModel class]]) {
            urlString = obj.bannerImgUrl;
        }
        if (urlString) {
