...
//                // 1.通知代理－－修改文字提示
//                if ([self.delegate respondsToSelector:@selector(circleViewNotFourTap:)]) {
//                    [self.delegate circleViewNotFourTap:@"LOGIN"];
//                }
//            }else{
...
//
//        //读取之前存储本地的手势密码
//        NSString *gesPwd = CMT_GesturesPasswordTool.gesturesPwdModel.gesturePwd;
//        if ([gesPwd isEqualToString:gesture]) {
//            // 改变状态为error
//            [self changeCircleInCircleSetWithState:CircleStateError];
//            // 手势结束后是否错误回显重绘，取决于是否延时清空数组和状态复原
//            [self errorToDisplay];
...
//            // 1.通知代理－－修改文字提示
//            if ([self.delegate respondsToSelector:@selector(circleViewNotFourTap:)]) {
//                [self.delegate circleViewNotFourTap:@"REPEAT"];
//            }
//            return;
//        }
