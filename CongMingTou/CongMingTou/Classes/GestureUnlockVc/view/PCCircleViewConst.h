 ...
 *  普通状态下内实心圆颜色
 */
#define CircleStateNormalInsideColor CommonWhiteColor

/**
 *  普通状态下上面的小内实心圆颜色
 */
#define SmallCircleStateNormalInsideColor [CMT_Tools colorWithHexString:@"#66c5ff"]

/**
 *  选中状态下内实心圆颜色
 */
#define CircleStateSelectedInsideColor  CommonWhiteColor
 ...
 *  普通时连线颜色
 */
#define CircleConnectLineNormalColor CommonWhiteColor
//rgba(34,178,246,1)
 ...
 */
#define CircleViewCenterY kScreenH * 2/3 - 30
 ...
 *  普通状态下文字提示的颜色
 */
#define textColorNormalState  CommonWhiteColor
//rgba(241,241,241,1)

/**
 *  警告状态下文字提示的颜色
 */
#define textColorWarningState  CommonWhiteColor
//rgba(254,82,92,1)
 ...
 *  设置时，连线个数少，提示文字
 */
#define gestureTextConnectLess [NSString stringWithFormat:@"为了保障安全，至少设置%d个连接点", CircleSetCountLeast]

/**
 *  确认图案，提示再次绘制
 */
#define gestureTextDrawAgain @"再来一次"

/**
 *  再次绘制不一致，提示文字
 */
#define gestureTextDrawAgainError @"密码不一致，请重新输入"
